    ...
    @auth()
        <div class="grid col-span-full">
            ...
            <div class="flex flex-col">
                <div>
                    {{ html()->label('name', __('layout.table_name'))->addClass(['text-white']) }}
                </div>
                <div class="mt-2">
                ...
                <div class="mt-4">
                    {{ html()->label('description', __('layout.table_description'))->addClass(['text-white']) }}
                </div>
                <div class="mt-2">
                ...
                @endif
                <div class="mt-4">
                    {{ html()->label('status_id', __('layout.table_status'))->addClass(['text-white']) }}
                </div>
                <div class="mt-2">
                ...
                <div class="mt-4">
                    {{ html()->submit(__('layout.update_button'))->addClass(['text-white', 'font-bold', 'py-2', 'px-4', 'rounded']) }}
                </div>
            </div>
            {{ html()->form()->close() }}
        </div>
